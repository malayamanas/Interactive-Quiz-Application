"""
Django settings for interactive_quiz project.
...
SECRET_KEY = "django-insecure-@ba-y1-8wb1_d6*qzaq32l@!px(f7^aiyp7#v=7!+&@c!q7ly0"
...
WSGI_APPLICATION = "interactive_quiz.wsgi.application"
